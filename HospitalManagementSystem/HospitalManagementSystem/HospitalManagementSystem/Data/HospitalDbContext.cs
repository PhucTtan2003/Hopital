...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA586D2C5461A");

            entity.ToTable("Account");

            entity.HasIndex(e => e.Username, "UQ__Account__536C85E4870C6D19").IsUnique();
        ...
        {
            entity.HasKey(e => e.AppointmentId).HasName("PK__Appointm__8ECDFCA28127750C");
            ...
            entity.HasOne(d => d.Department).WithMany(p => p.Appointments)
                ...
                .HasConstraintName("FK__Appointme__Depar__4D94879B");
        ...
        {
            entity.HasKey(e => e.BillingId).HasName("PK__Billing__F1656D13C6EABA5B");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BCD404F1131");
        ...
        {
            entity.HasKey(e => e.DoctorId).HasName("PK__Doctors__2DC00EDF4972AAAF");
        ...
        {
            entity.HasKey(e => e.DoctorSearchId).HasName("PK__DoctorSe__1CAABC0587575868");
        ...
        {
            entity.HasKey(e => e.EquipmentId).HasName("PK__Equipmen__34474599A0397FDA");
            ...
            entity.HasOne(d => d.Department).WithMany(p => p.Equipment)
                .HasForeignKey(d => d.DepartmentId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Equipment__Depar__60A75C0F");
        });

        modelBuilder.Entity<MedicalRecord>(entity =>
        {
            entity.HasKey(e => e.RecordId).HasName("PK__MedicalR__FBDF78C90E84B066");
        ...
        {
            entity.HasKey(e => e.MedicationId).HasName("PK__Medicati__62EC1ADA0F84C4EF");
        ...
        {
            entity.HasKey(e => e.PatientId).HasName("PK__Patients__970EC346EB4094E8");
        ...
        {
            entity.HasKey(e => e.PrescriptionId).HasName("PK__Prescrip__40130812F656D668");
            ...
            entity.HasOne(d => d.Doctor).WithMany(p => p.Prescriptions)
                .HasForeignKey(d => d.DoctorId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Prescript__Docto__571DF1D5");

            entity.HasOne(d => d.Medication).WithMany(p => p.Prescriptions)
                .HasForeignKey(d => d.MedicationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Prescript__Medic__5812160E");

            entity.HasOne(d => d.Patient).WithMany(p => p.Prescriptions)
                .HasForeignKey(d => d.PatientId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Prescript__Patie__5629CD9C");
        });

        modelBuilder.Entity<Room>(entity =>
        {
            entity.HasKey(e => e.RoomId).HasName("PK__Rooms__3286391906707478");
            ...
            entity.HasOne(d => d.Department).WithMany(p => p.Rooms)
                .HasForeignKey(d => d.DepartmentId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Rooms__Departmen__6383C8BA");
        });

        modelBuilder.Entity<SelectSpecialty>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__SelectSp__3214EC07C4D7A02F");
        ...
        {
            entity.HasKey(e => e.SessionId).HasName("PK__Sessions__C9F49270E5CABD2E");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__Staff__96D4AAF70BCA0056");
